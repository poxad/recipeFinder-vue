		...
		async fetchData() {
			try {
				...
				const response = await fetch(
					`https://api.spoonacular.com/recipes/findByIngredients?apiKey=bf906dceb9e444698d59bf480db9bb10&number=50&ingredients=${valueString}`
				);
